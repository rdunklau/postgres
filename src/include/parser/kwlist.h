...
PG_KEYWORD("final", FINAL, TYPE_FUNC_NAME_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("match_recognize", MATCH_RECOGNIZE, TYPE_FUNC_NAME_KEYWORD, AS_LABEL)
...
PG_KEYWORD("one", ONE, UNRESERVED_KEYWORD, BARE_LABEL)
...
PG_KEYWORD("running", RUNNING, TYPE_FUNC_NAME_KEYWORD, BARE_LABEL)
